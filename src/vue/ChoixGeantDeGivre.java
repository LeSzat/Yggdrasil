...
/**
 * JDialog qui permet au dieu de choisir quel géant de givre défausser pour l'effet 5 du Vane
 */
public class ChoixGeantDeGivre extends javax.swing.JDialog {

    /**
     * Creates new form ChoixGeantDeGivre
     */
    private static LinkedList<GeantDeGivre> lGeant;
    private GeantDeGivre gdg;

    public ChoixGeantDeGivre(java.awt.Frame parent, boolean modal, LinkedList<GeantDeGivre> lGeant) {
        super(parent, modal);
        ChoixGeantDeGivre.lGeant = lGeant;
        initComponents();
        gdg = lGeant.get(0);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quel geant voulez vous defausser");
